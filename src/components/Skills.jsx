        ...
        <section id="skills" className="relative py-12 md:py-16 bg-[#FFFBF5] overflow-hidden">
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                <div className="text-center mb-8 md:mb-12 space-y-4">
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-7xl font-bold text-text tracking-tighter uppercase animate-[fadeInUp_0.8s_ease-out]" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
