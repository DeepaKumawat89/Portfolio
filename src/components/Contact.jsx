                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-4 group">
                                            <div className="w-12 h-12 rounded-2xl bg-white shadow-sm flex items-center justify-center text-pista-dark group-hover:bg-pista-dark group-hover:text-white transition-all duration-300">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm font-bold text-text truncate">deepakkumawat31434@gmail.com</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-4 group">
                                            <div className="w-12 h-12 rounded-2xl bg-white shadow-sm flex items-center justify-center text-pista-dark group-hover:bg-pista-dark group-hover:text-white transition-all duration-300">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm font-bold text-text">+91 7499645939</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-4 group">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm font-bold text-text">/DeepaKumawat89</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-4 group">
                                            <div className="w-12 h-12 rounded-2xl bg-white shadow-sm flex items-center justify-center text-pista-dark group-hover:bg-pista-dark group-hover:text-white transition-all duration-300">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm font-bold text-text">Deepak Kumawat</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <button className="inline-flex items-center gap-4 px-8 py-4 bg-text text-white rounded-2xl font-bold uppercase tracking-widest text-[10px] hover:bg-pista-dark transition-all duration-500 hover:shadow-xl hover:-translate-y-1 group">
